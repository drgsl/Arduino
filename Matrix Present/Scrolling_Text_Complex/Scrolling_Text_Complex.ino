...
// Marquee text
char text[] = "      LMAAAAAAAAA!!! I LOVE YOU SO SO SO FUCKING MUCH! I LOVE U A LOT LYYY IUBIIIITA!!";
char text2[] = "      SISI SHOULD BE A MOTANEL AND PUFARIN A PISICUTA";
char text3[] = "      I BELIEVE IN U";
...
byte heart1[3][8] = {
  ...
  { 0x00, 0x66, 0xff, 0xdb, 0x66, 0x3c, 0x18, 0x00 } ,
...
void Hearts1() {
  ...
  for (int x = -7; x <= LEDMATRIX_WIDTH; x++) {
    lmd.clear();
    //    drawSprite( (byte*)&heart1[0], x - 32, 0, 8, 8 );
    //    drawSprite( (byte*)&heart1[0], x - 24, 0, 8, 8 );
    drawSprite( (byte*)&heart1[0], x - 16, 0, 8, 8 );
    drawSprite( (byte*)&heart1[0], x -  8, 0, 8, 8 );
    drawSprite( (byte*)&heart1[0], x     , 0, 8, 8 );
    drawSprite( (byte*)&heart1[0], x +  8, 0, 8, 8 );
    drawSprite( (byte*)&heart1[0], x + 16, 0, 8, 8 );
    //    drawSprite( (byte*)&heart1[0], x + 24, 0, 8, 8 );
    //    drawSprite( (byte*)&heart1[0], x + 32, 0, 8, 8 );
...
void Hearts2() {
  ...
  for (int x = 0; x <= LEDMATRIX_WIDTH; x += 8) {
    for (int y = 0; y <= 2; y++) {
      lmd.clear();
      drawSprite( (byte*)&heart1[y], x, 0, 8, 8 );
      lmd.display();
      delay(ANIM_DELAY);
    }
  }
