...
public class Mode_Changer___Processing extends PApplet {
...
//  }
//}
  public void settings() {  size(900, 200); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Mode_Changer___Processing" };
    if (passedArgs != null) {
